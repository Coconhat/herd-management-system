import { getAnimalByEarTag } from "@/lib/actions/animals";
...
export default async function Page({ params }: { params: { id: string } }) {
  ...
  const animals = await getAnimalByEarTag(params.id);

  const healthRecords = await getHealthRecordsByAnimalId(params.id);

  return (
    <div className="p-6">
      <h1 className="text-xl font-bold mb-4">Health Record</h1>
      <p className="text-sm text-muted-foreground mb-6">
        Manage health events for animal: {animals?.ear_tag}
      </p>
